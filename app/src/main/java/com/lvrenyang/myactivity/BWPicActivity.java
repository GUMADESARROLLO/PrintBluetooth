...
public class BWPicActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bitmap bm = getImageFromAssetsFile("blackwhite.png");
		if (null != bm) {
		...
		Pos.pictureUseFlowControl = true;
	}
	...
	static class MHandler extends Handler {
		...
		MHandler(BWPicActivity activity) {
			mActivity = new WeakReference<BWPicActivity>(activity);
		}

		@Override
		public void handleMessage(Message msg) {
			BWPicActivity theActivity = mActivity.get();
			switch (msg.what) {
